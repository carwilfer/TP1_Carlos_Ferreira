      ...
      <div class="col-3" v-bind:key="filme.id" v-for="filme in filmes">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <span class="mensagem-estoque" v-if="filme.estoqueDisponivel - quantidadeNoCarrinhoPorFilme(filme)===0">Indisponível</span>
            <span class="mensagem-estoque" v-else-if="filme.estoqueDisponivel - quantidadeNoCarrinhoPorFilme(filme)<5">Apenas {{ filme.estoqueDisponivel - quantidadeNoCarrinhoPorFilme(filme)}} itens no esttoque.</span>
            <span class="mensage-estoque" v-else>Alugue agora!</span>
            <p class="card-text">{{ filme.valor | formatarPreco("R$")}}</p>
            <div class="avaliacao">
              <span v-for="n in 5" :key="n">
                <b-icon icon="star-fill" variant="warning" v-if="n <= filme.avaliacao"></b-icon>
                <b-icon icon="star" variant="warning" v-else></b-icon>
              </span>
            </div>
      ...
      <div class="col-12">
        <form>
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="primeiroNome" placeholder="Digitar o primeiro nome" v-model.trim.lazy="pedido.primeiroNome">
          </div>
          <div class="form-group">
            <label for="ultimo.ultimoNome">Último nome</label>
            <input type="text" class="form-control" id="ultimoNome" placeholder="Digitar o último nome" v-model.trim.lazy="pedido.ultimoNome">
          </div>
          <div class="form-group">
            <label for="endereco">Endereço</label>
            <input type="text" class="form-control" id="endereco" placeholder="Digitar o endereço" v-model.trim.lazy="pedido.endereco">
          </div>
          <div class="form-group">
            <label for="cidade">Cidade</label>
            <input type="text" class="form-control" id="cidade" placeholder="Digitar a cidade" v-model.trim.lazy="pedido.cidade">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="cep" placeholder="Digitar o cep" v-model.number="pedido.cep">
          </div>
          ...
          <div class="form-group form-check-inline">
           <input type="radio" class="form-check-input" id="manha" value="Manhã"
             v-model="pedido.entrega">
           <label class="form-check-label" for="manha">Manhã</label>
         </div>
         <div class="form-group form-check-inline">
           <input type="radio" class="form-check-input" id="tarde" value="Tarde"
             v-model="pedido.entrega">
           <label class="form-check-label" for="tarde">Tarde</label>
         </div>
         <div class="form-group form-check-inline">
           <input
             type="radio" class="form-check-input" id="noite"  value="Noite"
             v-model="pedido.entrega">
    ...
    data: function(){
      return {
        ...
        filmes: [
          ...
          { id: 2, titulo: "Mulher-Maravilha 2", descricao: "<b>Wonder Woman 1984</b> é um futuro filme estadunidense de super-herói de 2020, baseado na personagem homônima da <b>DC Comics</b> e distribuído pela <b>Warner Bros. Pictures</b>. 05/06/2020 ", valor: 35, imagem: "https://media1.popsugar-assets.com/files/thumbor/75Xa0OZOmMbTn8rblmFKrFxOaEc/fit-in/728xorig/filters:format_auto-!!-:strip_icc-!!-/2019/12/09/659/n/1922283/4bd71b795dee5f188e2080.26134719_WW84_INSTA_V/i/Wonder-Woman-1984-Photos.jpg", estoqueFisponivel: 6, avaliacao: 4 },
          { id: 3, titulo: "Viúva Negra", descricao: "<b>Black Widow</b> é um futuro filme estadunidense, baseado na personagem de mesmo nome da <b>Marvel Comics</b>, produzido pela Marvel Studios e distribuído pela Walt Disney Studios Motion Pictures", valor: 20, imagem: "https://legadodamarvel.com.br/wp-content/uploads/2019/09/Vi%C3%BAva-Negra-Demolidor-legadodamarvel.jpg", estoqueFisponivel: 2, avaliacao: 3 },
          { id: 4, titulo: "Bad Boys para Sempre", descricao: "Os policiais <b>Mike Lowery e Marcus Burnett</b> se juntam para derrubar o líder de um cartel de drogas em Miami ao lado de <b>Mike e Marcus</b>, enfrenta o implacável Armando Armas.", valor: 40, imagem: "https://www.hojeemdia.com.br/polopoly_fs/1.769519.1580297506!/image/image.jpg_gen/derivatives/landscape_300/image.jpg", estoqueFisponivel: 8, avaliacao: 2 }],
